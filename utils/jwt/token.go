...
import (
	...
	"github.com/gofier/framework/support/cache"
	"github.com/gofier/framework/zone"

	"github.com/dgrijalva/jwt-go"
)

const ExpiredTime zone.Duration = 4 * zone.Hour
const RefreshExpiredTime zone.Duration = 10 * zone.Minute
const MaxRefreshTimes uint = 1

const REFRESH_TOKEN_CACHE_KEY = "GOFIER_REFRESH_TOKEN_%s"
const REVOKED_TOKEN_CACHE_KEY = "GOFIER_REVOKED_TOKEN_%s"
